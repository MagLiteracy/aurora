...
class TestShowLB(unittest.TestCase):
    ...
    def test_show_lb(self):
        ...
        self.assertTrue(driver.find_element_by_xpath('//*[@id="main"]/div/h1').is_displayed())
        self.assertTrue(driver.find_element_by_id('addPool').is_displayed())
        self.assertTrue(driver.find_element_by_id('delete').is_displayed())
