...
class TestSuspendInstance(unittest.TestCase):
    ...
    def test_suspend_instance(self):
        ...
        driver.find_element_by_id("suspend").click()
        driver.find_element_by_link_text("Compute").click()
        self.assertTrue(self.is_element_present(
            By.XPATH, '//*[text()="%s"]/..//..//*[text()="Suspended"]' % instance_name))
        driver.find_element_by_link_text(instance_name).click()
        driver.find_element_by_id("resume").click()
        driver.find_element_by_link_text("Compute").click()
        self.assertTrue(self.is_element_present(
