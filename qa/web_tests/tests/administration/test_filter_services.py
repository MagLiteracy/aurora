...
class TestFilterServices(unittest.TestCase):
    ...
    def test_filter_services(self):
        ...
        driver.find_element_by_xpath("//div/input[@type='text']").send_keys("nova")
        time.sleep(1)
        self.assertTrue(driver.find_element_by_xpath("//tbody/tr/td[text()='nova']").is_displayed())
        self.assertFalse(driver.find_element_by_xpath("//tbody/tr/td[text()='heat']").is_displayed())
