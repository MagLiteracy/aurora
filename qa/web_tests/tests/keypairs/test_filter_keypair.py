...
class TestFilterKeypairs(unittest.TestCase):
    ...
    def test_filter_keypairs(self):
        ...
        self.assertTrue(self.is_element_present(By.XPATH, '//*[@value="%s"]'
                                                          % keypair_name))
        driver.find_element_by_xpath("//div/input[@type='text']").send_keys(keypair_name)
        self.assertTrue(self.is_element_present(By.XPATH, '//*[@value="%s"]'
                                                          % keypair_name))
        driver.find_element_by_id('checkBox_%s' % keypair_name).click()
        driver.find_element_by_xpath("//*[@id='checkBox_%s']" % keypair_name)\
            .click()
